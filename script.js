document.addEventListener('DOMContentLoaded', function () {
   ...
   // Custom icons
   var arch = L.icon({
      iconUrl: 'https://www.tripsavvy.com/thmb/dRMQzyhir2_vVyIvlYpbuC_aGkc=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/gateway-to-the-west-561452183-5975330db501e800117858c8.jpg',
      iconSize: [30, 30],
   });
